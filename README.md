...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/maven_webDataSource" pool-name="maven_webDataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/maven_webDatabase;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="maven_webSecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/maven_webDataSource"/>
...
2. Add following snippet to log all messages from the application:
        ...
        <logger category="com.example.maven_web">
            <level name="ALL"/>
        </logger>
